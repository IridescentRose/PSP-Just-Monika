...
"2": ["[player], have you ever wondered what it feels like to die?"
...
"3": ["...Hey, are you having a bad day or anything like that?"
...
,"Try to find something you think is {i}pretty{/i} good, but not world-class."
...
,"Of course, if we {i}did{/i} end up getting any new members, I'd probably just end up deleting them anyway."
,"Well...with the hindsight I have now, that is."
,"Gosh, it feels like I've kinda grown as a person ever since you've joined the club."
...
,"I mean...I'm not sure if I could {i}actually{/i} see myself doing that."
